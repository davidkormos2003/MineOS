...
do
	local success, result = pcall(component.internet.request, "https://raw.githubusercontent.com/davidkormos2003/MineOS/master/Installer/Main.lua")
...
component.eeprom.set([[
	local connection, data, chunk = component.proxy(component.list("internet")()).request("https://raw.githubusercontent.com/davidkormos2003/MineOS/master/Installer/Main.lua"), ""
